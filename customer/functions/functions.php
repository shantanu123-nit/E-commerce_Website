...
// it is for get the ip address of the user
function getIp() {
...
function getPro(){
	...
	while ($row_pro=mysqli_fetch_array($run_pro)) {
		...
		<p style='margin-top:5px'><b> Price: ₹$pro_price </b></p>

		<a href='details.php?pro_id= $pro_id' style='float:left;padding-left:25px;margin-top:10px'>Details</a>

		<a href='index.php?add_cart= $pro_id'><button style='float:right;margin-right:27px;margin-top:10px'>Add to Cart</button></a></center>
		</div>";
	}
}
}
...
function getBrandPro(){
	...
	$count_brands=mysqli_num_rows($run_brand_pro);
		if($count_brands==0){
		echo "<h2 style='padding:20px;'>No products available in  this brand!! </h2>";
		exit();
	}
